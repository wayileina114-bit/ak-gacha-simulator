...
function colVisibleNames(){
  ...
  for(i2b=0;i2b<names2.length;i2b++){
    ...
    if(colF!=='all'&&colF!=='miss'&&colF!=='lim'&&colF!=='favop'&&colF!=='wish'&&String(o2b.rarity)!==colF)continue;
