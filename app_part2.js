...
function openAbout(){
  ...
  h.push('<div class="wikisec"><h4>📦 明日方舟 · 干员寻访模拟器 <b>v12.02</b></h4>');
...
function applyTheme(){
  ...
  if(!THEME_NAMES[t]){ t='default'; state.theme=t; }
