...
function isGiftOp(name){ var o=opOf(name); if(!o||!o.gain)return false; var g=o.gain; if(g.indexOf('寻访')>=0)return false; return g.indexOf('活动获得')>=0||g.indexOf('主线剧情')>=0||g.indexOf('预约奖励')>=0||g.indexOf('记录修复')>=0||g.indexOf('凭证交易所')>=0; }
