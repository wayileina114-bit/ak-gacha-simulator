...
function getPool(b){
  if(!b._pool){
    ...
    if(b.type==='direct'){
      ...
      p6=restricted?b.six.slice():uniq(b.six.concat(poolStd(b, DATA.zj6||DATA.std6)));
      p5=restricted?b.five.slice():uniq(b.five.concat(poolStd(b, DATA.zj5||DATA.std5)));
    }else{
      p6=restricted?b.six.slice():uniq(b.six.concat(poolStd(b, DATA.std6)));
      p5=restricted?b.five.slice():uniq(b.five.concat(poolStd(b, DATA.std5)));
    }
    b._pool={p6:p6,p5:p5};
  }
  return b._pool;
