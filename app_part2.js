...
function bannerStatus(b){
  try{
    ...
    if(b.start<=today&&today<=b.end){
      ...
      return {s:'active',txt:txt,days:days};
    }
    if(today<b.start){
      ...
      return {s:'soon',txt:txt2,days:days2};
    }
...
function openAbout(){
  ...
  h.push('<div class="wikisec"><h4>📦 明日方舟 · 干员寻访模拟器 <b>v11.72</b></h4>');
